...
function VulnList:loadtab()
	...
	self:additem(h,'JavaScript (Client-Side)',symini.getrescount('CODE_JS_CLIENT'),NA,NA,NA,NA)
	self:additem(h,'JavaScript (Server-Side)',symini.getrescount('CODE_JS_SERVER'),NA,NA,NA,NA)
	self:additem(h,'Java',symini.getrescount('CODE_JSP'),NA,NA,NA,NA)
	self:additem(h,'Lua',symini.getrescount('CODE_LUA'),NA,NA,NA,NA)
