...
function SessionManager:show_sessiondetails(sesname)
 ...
 local hasvuln = false
  ...
  r:add('<tr .header><th width="20%">Description</th><th width="30%">Location</th><th width="20%">Affected Param(s)</th><th width="10%">Line(s)</th><th width="10%">Risk</th></tr>')
...
function SessionManager:comparesessions(basesesname,secondsesname)
  ...
  r:add('<widget type="select" style="padding:0;">')
  r:add('<table name="reportview" width="100%" cellspacing=-1px fixedrows=1>')
  r:add('<tr .header><th width="20%">Description</th><th width="30%">Location</th><th width="20%">Affected Param(s)</th><th width="10%">Line(s)</th><th width="10%">Risk</th><th width="10%">Comparison Status</th></tr>')
  v = ctk.string.loop:new()
