...
function TrackerManager:gettrackeroptionlist(apptype)
  ...
  while slp:parsing() do
    ...
    if canadd == true then
      if apptype == nil then
      menu:add('<option value="'..name..'">'..name..' ('..string.upper(app)..')</option>')
      else
...
function TrackerManager:ViewIssueTrackers(newtab)
 ...
 t.menu = [[
  ...
  <hr/>
  <li onclick="TrackerManager:DoIssueTrackerAction('test','%i')">Submit Test</li>
  <hr/>  
  <li onclick="TrackerManager:DoIssueTrackerAction('testdebug','%i')">Submit Test (Debug)</li>
  <hr/>
