...
function quickinject:add()
 reqbuilder.toolbar:addhtmlfile('#toolbar','PenTools.scx#Scripts/quickinject/toolbar.html')
...
function quickinject:editprefs()
 local t = {}
 t.html = PenTools:getfile('Scripts/quickinject/prefs.html')
...
function quickinject:viewsheet(filename)
 local source = PenTools:getfile('Scripts/quickinject/'..filename)
